	            ...
	            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
	                ...
	                <tbody>
	                    ...
	                    <tr class="odd gradeX">
	                        ...
	                        <td class="center">
	                        	@if($ds->status ==0)
	                        	<button class="btn btn-default btn-danger"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/dish/delete/{{ $ds->id }}">Khôi phục</a></button><br>
	                        	@else
                            	<button class="btn btn-default "><i class="fa fa-trash-o  fa-fw"></i><a href="admin/dish/delete/{{ $ds->id }}">Xóa</a></button><br>
                            	@endif
                            <button class="btn btn-default">
                            <i class="fa fa-pencil fa-fw"></i> <a href="admin/dish/edit/{{ $ds->id }}">Sửa</a>
                            </button>
                        	</td>      
	                    </tr>     
	                    @endforeach               
