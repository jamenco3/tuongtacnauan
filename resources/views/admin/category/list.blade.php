...
<div class="span9" id="content">                  
	...
	<div class="block">
	    <div class="navbar navbar-inner block-header">
	        <div class="muted pull-left">Category->List</div>
	    </div>
	                    ...
	                    <tr class="odd gradeX">
                        	...
                        	@endif
	                       	<td class="center">
                            	...
                            	@else
                            		<button class="btn btn-default "><i class="fa fa-trash-o  fa-fw"></i><a href="admin/category/delete/{{ $cate->id }}">Xóa</a></button><br>
                            	@endif
                            <button class="btn btn-default">
                            <i class="fa fa-pencil fa-fw"></i> <a href="admin/category/edit/{{ $cate->id }}">Sửa</a>
                            </button>
                        	</td>                                    
	                    </tr>
	                    @endforeach
