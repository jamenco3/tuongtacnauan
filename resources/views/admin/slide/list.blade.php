	            ...
	            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
	                ...
	                <tbody>
                    	...
                    	<tr class="odd gradeX" align="center">
	                        ...
	                        <td>{{ $sd->link }}</td>
	                        <td class="center">
	                            <button class="btn btn-info btn-action"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/slide/delete/{{ $sd->id }}">Xóa</a></button><br>
	                            <button class="btn btn-default btn-success">
	                            <i class="fa fa-pencil fa-fw"></i> <a href="admin/slide/edit/{{ $sd->id }}">Sửa</a>
	                            </button>
	                        </td>
                    	</tr>
                    	@endforeach          
