...
<section id="mu-gallery">
    <div id="DIV_1" style="margin-top: 160px;height: auto;">
        <div id="DIV_2">
            <div id="DIV_3">
                <ul id="UL_4">
                    <li id="LI_5">
        ...
        <div id="DIV_10" style="height: 4694px;">
            <div id="DIV_11" style="height: 4694px">
                    ...
                    <div id="DIV_13">
                        <img src="upload/dish/{{$Dish->image}}" alt="Cách làm {{$recipe->name}}" id="IMG_14" />           <!--  Chèn ảnh Món Ăn -->
                    </div>
                    <div id="DIV_15">
                        <div id="DIV_16">
                            <div id="DIV_17">
                                 <span id="SPAN_18" style=" width: 120px;"> <span id="SPAN_19">Mục đích</span> <span id="SPAN_20">{{$Category->name}}</span></span> <span id="SPAN_21"> <span id="SPAN_22">Cách thức thực hiện</span> <span id="SPAN_23">Nướng</span></span>
                            </div>
                            <h1 id="H1_24">
                                {{ $recipe->name }}   
                            </h1>
                        ...
                        <div id="DIV_40">
                            ...
                            <ul id="UL_43">
                                ...
                                <li id="LI_49">
                                    <div id="DIV_50">
                                         <span id="SPAN_51">Thực hiện</span> <span id="SPAN_52"> <span id="SPAN_53"><b id="B_54"></b></span></span>
                                        <time id="TIME_55">
                                            {{$recipe->time}}
                                ...
                                <li id="LI_57">
                                    <div id="DIV_58">
                                         <span id="SPAN_59" style="color: black">Phần ăn </span> <span id="SPAN_60"><b id="B_61">{{$recipe->eater}}</b> người</span>
                                    </div>
                                </li>
                                <li id="LI_62">
                                    <div id="DIV_63">
                                ...
                                <div id="DIV_195">
                                    <div id="DIV_196">
                                        <div id="DIV_197">
                                            ...
                                            <div>
                                                cho <span id="SPAN_200"><strong id="STRONG_201">2</strong><strong id="STRONG_202">{{$recipe->eater}}</strong></span> Phần ăn
                                            </div>
                                        </div>
                                        <div id="DIV_203">
                                            <div id="DIV_204">
                                            ...
                                            <div class="erorr" id="diverorr" style="position: absolute;bottom: -28px;right: 74px;color: red;display: none;">
                                                    ...
                                                    <li id="LI_296">
                                                        ...
                                                        <ul id="UL_297" style="width: 800px">
                                                            ...
                                                            <li id="LI_298" style="width: 372px">
                                                                <ul id="UL_299">
                                                                    <li id="LI_300">
                                                                        <span id="SPAN_301"></span><span id="SPAN_302"></span><span id="SPAN_303"></span>
                                                                    </li>
                                ...
                                <div id="DIV_435" style="height: 3000px">
                                    <div id="DIV_436" style="height:3000px ">
                                        <div id="DIV_437">
                                            ...
                                            <div id="DIV_439">
                                                 <span id="SPAN_440"> <span id="SPAN_441">Thực hiện</span> <span id="SPAN_442"> <b id="B_443">{{$recipe->time}}</b>m</span></span>
                                            </div>
                                        ...
                                        <div id="DIV_452" style="height: 2750px">
                                                ...
                                                <div id="DIV_455" style="height: auto;">
                                                    ...
                                                    <div id="DIV_456" style="height: 450px">  

                                                                <!-- Step 1 -->

                                                        <div id="DIV_457">
                                                            <h4 id="H4_458">
                                                                 <a href="" id="A_459">Bước <span id="SPAN_460"></span></a>{{$i+1}} <a href="" id="A_461"><!-- <span id="SPAN_462"></span> --></a>
                                                            </h4>
                                                        </div>
                                                            ...
                                                            <div id="DIV_464" style="height: 400px">
                                                                ...
                                                                <div id="DIV_471">
                                                                     <a href="" id="A_472"><img alt="Sandwich thịt nguội và phô mai nướng giòn - Croque Monsieur" src="upload/recipes/{{$ArrayImage[$i]}}" id="IMG_473" style="" />
                                                                     </a> 
                                                                </div>
                                            ...
                                            <div id="DIV_735">
                                                <div id="DIV_736">
                                                    ...
                                                    <div id="DIV_760">
                                                        ...
                                                        <input type="text" placeholder="Nội dung thảo luận..." name="temp-review-content" id="INPUT_762" /> <span id="SPAN_763"> 
                                                            <button id="BUTTON_764">
                                                                Gửi bình luận
                                                            </button></span>
                                                    </div>
        ...
        <div id="DIV_840" style="right: 54px;top: 187px;height: 1568px" >
                                                ...
                                                <div id="DIV_858 " style="width: 185px">
                                                    <div id="DIV_859">
                                                        <div id="DIV_860" style="width: 600px;">
                                                             <a href="{{route('recipes', $listrecipes->id)}}" title="Cách Bàm {{$listrecipes->name}} Tại Nhà" id="A_861">
                                                                <img alt="" src="upload/recipes/{{$listrecipes->image_1}}" style="width: 140px" />
                                                                
                                                             </a>
                                                        </div>
                                                        <div id="DIV_863" style="padding: 24px 0px 0px;">
                                                             <a href="{{route('recipes', $listrecipes->id)}}" title="Cách làm {{$listrecipes->name}}" id="A_864">
                                                              <h1 style="font-size: 11px;color: black;margin-top: 3px;font-weight: bold;">{{$listrecipes->name}}</h1>   
                                                             </a>
